 ...
 */
function fithub_theme_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'fithub-theme' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'fithub-theme' ),
...
add_action( 'widgets_init', 'fithub_theme_widgets_init' );
